...
python3 process_eval.py -t ../evaluation/results/taxonomies/all_true_like_taxogen_depth_3_4.csv -e ../evaluation/results/evaluations/all_true_th_0.25_depth_4_compound_counts_iter_expansion
"""
